...
В каталоге:
   ...
   Файлы задания: написать сервис, который будет мониторить лог,
                  на наличие ключевого слова
   ...
   Файлы задания: Из epel установить spawn-fcgi, переписать init-скрипт
                  на unit-файл 
